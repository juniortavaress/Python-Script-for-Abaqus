...
class DataInicialization():
    ...
    # Define file paths for various data inputs and results used in the simulation.
    def get_paths(self):
        self.path_datas_input = os.path.join(self.main_path,  'data/dataInput.json')
        self.path_datas_result = os.path.join(self.main_path,  'data\\resultsDatas')
        self.path_folder_simulation_datas = os.path.join(self.main_path, 'data/simulationDatas')
    ...
    def get_defaut_datas(self):
        data = AuxFunctions.open_dict('dict', self.path_defaut_datas_input)
