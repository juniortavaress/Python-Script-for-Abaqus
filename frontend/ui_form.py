...
"")
        ...
        self.label_16.setPixmap(QPixmap(u"Icons/programmer.png"))
        ...
        self.label_22.setPixmap(QPixmap(u"Icons/abaqusIcon.png"))
...
"}")
        ...
        self.label_19.setMinimumSize(QSize(200, 200))
        self.label_19.setMaximumSize(QSize(300, 300))
        self.label_19.setPixmap(QPixmap(u"Icons/img01.png"))
...
"}")
        ...
        self.label_23.setMinimumSize(QSize(250, 200))
        self.label_23.setMaximumSize(QSize(350, 300))
        self.label_23.setPixmap(QPixmap(u"Icons/img02.png"))
...
"}")
        ...
        self.label_26.setMinimumSize(QSize(300, 300))
        self.label_26.setMaximumSize(QSize(300, 300))
        self.label_26.setPixmap(QPixmap(u"Icons/img01.png"))
...
"")
        ...
        self.pushButton_3 = QPushButton(self.frame_153)
...
"")
        ...
        self.label_27.setPixmap(QPixmap(u"Icons/dimensions.png"))
...
"}")
        ...
        self.iterateAndDirectoryPage = QWidget()
        self.iterateAndDirectoryPage.setObjectName(u"iterateAndDirectoryPage")
        self.verticalLayout_6 = QVBoxLayout(self.iterateAndDirectoryPage)
        self.verticalLayout_6.setSpacing(0)
        self.verticalLayout_6.setObjectName(u"verticalLayout_6")
        self.verticalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.frame_158 = QFrame(self.iterateAndDirectoryPage)
        ...
        self.verticalLayout_315 = QVBoxLayout(self.frame_158)
        ...
        self.frame_161.setMinimumSize(QSize(0, 78))
        self.frame_161.setMaximumSize(QSize(16777215, 78))
...
"")
        ...
        self.horizontalLayout_187 = QHBoxLayout(self.frame_161)
        self.horizontalLayout_187.setObjectName(u"horizontalLayout_187")
        self.label_30 = QLabel(self.frame_161)
        self.label_30.setObjectName(u"label_30")
        self.label_30.setMinimumSize(QSize(60, 60))
        self.label_30.setMaximumSize(QSize(60, 60))
        self.label_30.setPixmap(QPixmap(u":/icons/Icons/process.png"))
        self.label_30.setScaledContents(True)

        self.horizontalLayout_187.addWidget(self.label_30)

        self.label_94 = QLabel(self.frame_161)
...
"")
        ...
        self.horizontalLayout_187.addWidget(self.label_94)


        self.verticalLayout_315.addWidget(self.frame_161)

        self.frame_479 = QFrame(self.frame_158)
        self.frame_479.setObjectName(u"frame_479")
        self.frame_479.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_479.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_188 = QHBoxLayout(self.frame_479)
        self.horizontalLayout_188.setSpacing(9)
        self.horizontalLayout_188.setObjectName(u"horizontalLayout_188")
        self.horizontalLayout_188.setContentsMargins(18, 18, 18, 0)
        self.frame_8 = QFrame(self.frame_479)
...
"")
        ...
        self.frame_620 = QFrame(self.frame_70)
        self.frame_620.setObjectName(u"frame_620")
        self.frame_620.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.frame_620.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_620.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_51 = QHBoxLayout(self.frame_620)
        self.horizontalLayout_51.setObjectName(u"horizontalLayout_51")
        self.label_41 = QLabel(self.frame_620)
        ...
        self.numberOfVariables_3 = QComboBox(self.frame_620)
        self.numberOfVariables_3.addItem("")
        self.numberOfVariables_3.addItem("")
        self.numberOfVariables_3.addItem("")
        self.numberOfVariables_3.setObjectName(u"numberOfVariables_3")
        self.numberOfVariables_3.setMinimumSize(QSize(60, 20))
        self.numberOfVariables_3.setMaximumSize(QSize(60, 20))
        self.numberOfVariables_3.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.numberOfVariables_3.setStyleSheet(u"QComboBox {\n"
"	padding-left: 10px;\n"
"}")
        self.numberOfVariables_3.setFrame(True)

        self.horizontalLayout_51.addWidget(self.numberOfVariables_3)


        self.verticalLayout_52.addWidget(self.frame_620)

        self.frameParameter01_5 = QFrame(self.frame_70)
        self.frameParameter01_5.setObjectName(u"frameParameter01_5")
        self.frameParameter01_5.setEnabled(True)
        self.frameParameter01_5.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.frameParameter01_5.setFrameShape(QFrame.Shape.StyledPanel)
        self.frameParameter01_5.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_104 = QVBoxLayout(self.frameParameter01_5)
        self.verticalLayout_104.setObjectName(u"verticalLayout_104")
        self.verticalLayout_104.setContentsMargins(0, -1, 0, -1)
        self.frame_134 = QFrame(self.frameParameter01_5)
        ...
        self.horizontalLayout_59 = QHBoxLayout(self.frame_134)
        self.horizontalLayout_59.setObjectName(u"horizontalLayout_59")
        self.label_95 = QLabel(self.frame_134)
        self.label_95.setObjectName(u"label_95")
        self.label_95.setFont(font6)

        self.horizontalLayout_59.addWidget(self.label_95)

        self.P01_3 = QComboBox(self.frame_134)
        self.P01_3.addItem("")
        self.P01_3.addItem("")
        self.P01_3.addItem("")
        self.P01_3.addItem("")
        self.P01_3.addItem("")
        self.P01_3.setObjectName(u"P01_3")
        self.P01_3.setEnabled(False)
        self.P01_3.setMinimumSize(QSize(0, 20))
        self.P01_3.setMaximumSize(QSize(16777215, 20))

        self.horizontalLayout_59.addWidget(self.P01_3)


        self.verticalLayout_104.addWidget(self.frame_134)

        self.frame_75 = QFrame(self.frameParameter01_5)
        ...
        self.label_96 = QLabel(self.frame_75)
        self.label_96.setObjectName(u"label_96")

        self.horizontalLayout_52.addWidget(self.label_96)

        self.minP01_3 = QLineEdit(self.frame_75)
        self.minP01_3.setObjectName(u"minP01_3")
        self.minP01_3.setEnabled(False)
        self.minP01_3.setMinimumSize(QSize(0, 20))
        self.minP01_3.setMaximumSize(QSize(16777215, 20))
        self.minP01_3.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_52.addWidget(self.minP01_3)

        self.label_97 = QLabel(self.frame_75)
        self.label_97.setObjectName(u"label_97")

        self.horizontalLayout_52.addWidget(self.label_97)

        self.maxP01_3 = QLineEdit(self.frame_75)
        self.maxP01_3.setObjectName(u"maxP01_3")
        self.maxP01_3.setEnabled(False)
        self.maxP01_3.setMinimumSize(QSize(0, 20))
        self.maxP01_3.setMaximumSize(QSize(16777215, 20))
        self.maxP01_3.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_52.addWidget(self.maxP01_3)

        self.label_98 = QLabel(self.frame_75)
        self.label_98.setObjectName(u"label_98")

        self.horizontalLayout_52.addWidget(self.label_98)

        self.stepP01_3 = QComboBox(self.frame_75)
        self.stepP01_3.addItem("")
        self.stepP01_3.addItem("")
        self.stepP01_3.addItem("")
        self.stepP01_3.addItem("")
        self.stepP01_3.addItem("")
        ...
        self.stepP01_3.addItem("")
        self.stepP01_3.addItem("")
        self.stepP01_3.setObjectName(u"stepP01_3")
        self.stepP01_3.setEnabled(False)
        self.stepP01_3.setMinimumSize(QSize(0, 20))
        self.stepP01_3.setMaximumSize(QSize(16777215, 20))
        self.stepP01_3.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.stepP01_3.setStyleSheet(u"QComboBox {\n"
"	padding-left: 23px;\n"
"}")
        self.stepP01_3.setInsertPolicy(QComboBox.InsertPolicy.InsertAtBottom)
        self.stepP01_3.setSizeAdjustPolicy(QComboBox.SizeAdjustPolicy.AdjustToContentsOnFirstShow)

        self.horizontalLayout_52.addWidget(self.stepP01_3)


        self.verticalLayout_104.addWidget(self.frame_75)


        self.verticalLayout_52.addWidget(self.frameParameter01_5)

        self.frameParameter01_6 = QFrame(self.frame_70)
        self.frameParameter01_6.setObjectName(u"frameParameter01_6")
        self.frameParameter01_6.setEnabled(True)
        self.frameParameter01_6.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.frameParameter01_6.setFrameShape(QFrame.Shape.StyledPanel)
        self.frameParameter01_6.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_410 = QVBoxLayout(self.frameParameter01_6)
        self.verticalLayout_410.setObjectName(u"verticalLayout_410")
        self.verticalLayout_410.setContentsMargins(0, -1, 0, -1)
        self.frame_163 = QFrame(self.frameParameter01_6)
        ...
        self.horizontalLayout_240 = QHBoxLayout(self.frame_163)
        self.horizontalLayout_240.setObjectName(u"horizontalLayout_240")
        self.label_35 = QLabel(self.frame_163)
        self.label_35.setObjectName(u"label_35")
        self.label_35.setFont(font6)

        self.horizontalLayout_240.addWidget(self.label_35)

        self.P02_3 = QComboBox(self.frame_163)
        self.P02_3.addItem("")
        self.P02_3.addItem("")
        self.P02_3.addItem("")
        self.P02_3.addItem("")
        self.P02_3.addItem("")
        self.P02_3.setObjectName(u"P02_3")
        self.P02_3.setEnabled(False)
        self.P02_3.setMinimumSize(QSize(0, 20))
        self.P02_3.setMaximumSize(QSize(16777215, 20))

        self.horizontalLayout_240.addWidget(self.P02_3)


        self.verticalLayout_410.addWidget(self.frame_163)

        self.frame_164 = QFrame(self.frameParameter01_6)
        ...
        self.horizontalLayout_241 = QHBoxLayout(self.frame_164)
        self.horizontalLayout_241.setObjectName(u"horizontalLayout_241")
        self.horizontalLayout_241.setContentsMargins(0, 0, 0, 0)
        self.frame_621 = QFrame(self.frame_164)
        self.frame_621.setObjectName(u"frame_621")
        self.frame_621.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_621.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_60 = QHBoxLayout(self.frame_621)
        self.horizontalLayout_60.setObjectName(u"horizontalLayout_60")
        self.label_36 = QLabel(self.frame_621)
        self.label_36.setObjectName(u"label_36")

        self.horizontalLayout_60.addWidget(self.label_36)

        self.minP02_3 = QLineEdit(self.frame_621)
        self.minP02_3.setObjectName(u"minP02_3")
        self.minP02_3.setEnabled(False)
        self.minP02_3.setMinimumSize(QSize(0, 20))
        self.minP02_3.setMaximumSize(QSize(16777215, 20))
        self.minP02_3.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_60.addWidget(self.minP02_3)

        self.label_42 = QLabel(self.frame_621)
        self.label_42.setObjectName(u"label_42")

        self.horizontalLayout_60.addWidget(self.label_42)

        self.maxP02_3 = QLineEdit(self.frame_621)
        self.maxP02_3.setObjectName(u"maxP02_3")
        self.maxP02_3.setEnabled(False)
        self.maxP02_3.setMinimumSize(QSize(0, 20))
        self.maxP02_3.setMaximumSize(QSize(16777215, 20))
        self.maxP02_3.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_60.addWidget(self.maxP02_3)

        self.label_99 = QLabel(self.frame_621)
        self.label_99.setObjectName(u"label_99")

        self.horizontalLayout_60.addWidget(self.label_99)

        self.stepP02_3 = QComboBox(self.frame_621)
        self.stepP02_3.addItem("")
        self.stepP02_3.addItem("")
        self.stepP02_3.addItem("")
        self.stepP02_3.addItem("")
        self.stepP02_3.addItem("")
        ...
        self.stepP02_3.addItem("")
        self.stepP02_3.addItem("")
        self.stepP02_3.setObjectName(u"stepP02_3")
        self.stepP02_3.setEnabled(False)
        self.stepP02_3.setMinimumSize(QSize(0, 20))
        self.stepP02_3.setMaximumSize(QSize(16777215, 20))
        self.stepP02_3.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.stepP02_3.setStyleSheet(u"QComboBox {\n"
"	padding-left: 23px;\n"
"}")
        self.stepP02_3.setInsertPolicy(QComboBox.InsertPolicy.InsertAtBottom)
        self.stepP02_3.setSizeAdjustPolicy(QComboBox.SizeAdjustPolicy.AdjustToContentsOnFirstShow)

        self.horizontalLayout_60.addWidget(self.stepP02_3)


        self.horizontalLayout_241.addWidget(self.frame_621)


        self.verticalLayout_410.addWidget(self.frame_164)


        self.verticalLayout_52.addWidget(self.frameParameter01_6)

        self.iterationWarning_3 = QFrame(self.frame_70)
        self.iterationWarning_3.setObjectName(u"iterationWarning_3")
        self.iterationWarning_3.setMinimumSize(QSize(0, 30))
        self.iterationWarning_3.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.iterationWarning_3.setFrameShape(QFrame.Shape.StyledPanel)
        self.iterationWarning_3.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_53 = QVBoxLayout(self.iterationWarning_3)
        self.verticalLayout_53.setSpacing(0)
        self.verticalLayout_53.setObjectName(u"verticalLayout_53")
        self.verticalLayout_53.setContentsMargins(5, 0, 5, 0)
        self.labelIterationWarning_3 = QLabel(self.iterationWarning_3)
        self.labelIterationWarning_3.setObjectName(u"labelIterationWarning_3")
        self.labelIterationWarning_3.setMinimumSize(QSize(0, 20))
        self.labelIterationWarning_3.setStyleSheet(u"color: rgb(255, 0, 0);\n"
"font-size: 12px;")
        self.labelIterationWarning_3.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_53.addWidget(self.labelIterationWarning_3)


        self.verticalLayout_52.addWidget(self.iterationWarning_3)


        self.horizontalLayout.addWidget(self.frame_70)

        self.frame_76 = QFrame(self.frame_480)
        self.frame_76.setObjectName(u"frame_76")
        self.frame_76.setStyleSheet(u"QLabel {\n"
"    font-size: 15px; /* Tamanho da fonte */\n"
"	font-family: \"Yu Gothic UI Semilight\"; /* Fam\u00edlia da fonte */\n"
"}\n"
"\n"
...
"")
        ...
        self.verticalLayout_54 = QVBoxLayout(self.frame_76)
        self.verticalLayout_54.setObjectName(u"verticalLayout_54")
        self.frame_622 = QFrame(self.frame_76)
        self.frame_622.setObjectName(u"frame_622")
        self.frame_622.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.frame_622.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_622.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_61 = QHBoxLayout(self.frame_622)
        self.horizontalLayout_61.setObjectName(u"horizontalLayout_61")
        self.label_100 = QLabel(self.frame_622)
        self.label_100.setObjectName(u"label_100")
        self.label_100.setFont(font6)

        self.horizontalLayout_61.addWidget(self.label_100)

        self.numberOfVariables_4 = QComboBox(self.frame_622)
        self.numberOfVariables_4.addItem("")
        self.numberOfVariables_4.addItem("")
        self.numberOfVariables_4.addItem("")
        self.numberOfVariables_4.setObjectName(u"numberOfVariables_4")
        self.numberOfVariables_4.setMinimumSize(QSize(60, 20))
        self.numberOfVariables_4.setMaximumSize(QSize(60, 20))
        self.numberOfVariables_4.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.numberOfVariables_4.setStyleSheet(u"QComboBox {\n"
"	padding-left: 10px;\n"
"}")
        self.numberOfVariables_4.setFrame(True)

        self.horizontalLayout_61.addWidget(self.numberOfVariables_4)


        self.verticalLayout_54.addWidget(self.frame_622)

        self.frameParameter01_7 = QFrame(self.frame_76)
        self.frameParameter01_7.setObjectName(u"frameParameter01_7")
        self.frameParameter01_7.setEnabled(True)
        self.frameParameter01_7.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.frameParameter01_7.setFrameShape(QFrame.Shape.StyledPanel)
        self.frameParameter01_7.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_105 = QVBoxLayout(self.frameParameter01_7)
        self.verticalLayout_105.setObjectName(u"verticalLayout_105")
        self.verticalLayout_105.setContentsMargins(0, -1, 0, -1)
        self.frame_135 = QFrame(self.frameParameter01_7)
        ...
        self.horizontalLayout_62 = QHBoxLayout(self.frame_135)
        self.horizontalLayout_62.setObjectName(u"horizontalLayout_62")
        self.label_101 = QLabel(self.frame_135)
        self.label_101.setObjectName(u"label_101")
        self.label_101.setFont(font6)

        self.horizontalLayout_62.addWidget(self.label_101)

        self.P01_4 = QComboBox(self.frame_135)
        self.P01_4.addItem("")
        self.P01_4.addItem("")
        self.P01_4.addItem("")
        self.P01_4.addItem("")
        self.P01_4.addItem("")
        self.P01_4.setObjectName(u"P01_4")
        self.P01_4.setEnabled(False)
        self.P01_4.setMinimumSize(QSize(0, 20))
        self.P01_4.setMaximumSize(QSize(16777215, 20))

        self.horizontalLayout_62.addWidget(self.P01_4)


        self.verticalLayout_105.addWidget(self.frame_135)

        self.frame_77 = QFrame(self.frameParameter01_7)
        self.frame_77.setObjectName(u"frame_77")
        self.frame_77.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_77.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_63 = QHBoxLayout(self.frame_77)
        self.horizontalLayout_63.setSpacing(10)
        self.horizontalLayout_63.setObjectName(u"horizontalLayout_63")
        self.label_102 = QLabel(self.frame_77)
        self.label_102.setObjectName(u"label_102")

        self.horizontalLayout_63.addWidget(self.label_102)

        self.minP01_4 = QLineEdit(self.frame_77)
        self.minP01_4.setObjectName(u"minP01_4")
        self.minP01_4.setEnabled(False)
        self.minP01_4.setMinimumSize(QSize(0, 20))
        self.minP01_4.setMaximumSize(QSize(16777215, 20))
        self.minP01_4.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_63.addWidget(self.minP01_4)

        self.label_103 = QLabel(self.frame_77)
        self.label_103.setObjectName(u"label_103")

        self.horizontalLayout_63.addWidget(self.label_103)

        self.maxP01_4 = QLineEdit(self.frame_77)
        self.maxP01_4.setObjectName(u"maxP01_4")
        self.maxP01_4.setEnabled(False)
        self.maxP01_4.setMinimumSize(QSize(0, 20))
        self.maxP01_4.setMaximumSize(QSize(16777215, 20))
        self.maxP01_4.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_63.addWidget(self.maxP01_4)

        self.label_104 = QLabel(self.frame_77)
        self.label_104.setObjectName(u"label_104")

        self.horizontalLayout_63.addWidget(self.label_104)

        self.stepP01_4 = QComboBox(self.frame_77)
        self.stepP01_4.addItem("")
        self.stepP01_4.addItem("")
        self.stepP01_4.addItem("")
        self.stepP01_4.addItem("")
        self.stepP01_4.addItem("")
        ...
        self.stepP01_4.addItem("")
        self.stepP01_4.addItem("")
        self.stepP01_4.setObjectName(u"stepP01_4")
        self.stepP01_4.setEnabled(False)
        self.stepP01_4.setMinimumSize(QSize(0, 20))
        self.stepP01_4.setMaximumSize(QSize(16777215, 20))
        self.stepP01_4.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.stepP01_4.setStyleSheet(u"QComboBox {\n"
"	padding-left: 23px;\n"
"}")
        self.stepP01_4.setInsertPolicy(QComboBox.InsertPolicy.InsertAtBottom)
        self.stepP01_4.setSizeAdjustPolicy(QComboBox.SizeAdjustPolicy.AdjustToContentsOnFirstShow)

        self.horizontalLayout_63.addWidget(self.stepP01_4)


        self.verticalLayout_105.addWidget(self.frame_77)


        self.verticalLayout_54.addWidget(self.frameParameter01_7)

        self.frameParameter01_8 = QFrame(self.frame_76)
        self.frameParameter01_8.setObjectName(u"frameParameter01_8")
        self.frameParameter01_8.setEnabled(True)
        self.frameParameter01_8.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.frameParameter01_8.setFrameShape(QFrame.Shape.StyledPanel)
        self.frameParameter01_8.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_411 = QVBoxLayout(self.frameParameter01_8)
        self.verticalLayout_411.setObjectName(u"verticalLayout_411")
        self.verticalLayout_411.setContentsMargins(0, -1, 0, -1)
        self.frame_165 = QFrame(self.frameParameter01_8)
        self.frame_165.setObjectName(u"frame_165")
        self.frame_165.setEnabled(True)
        self.frame_165.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_165.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_242 = QHBoxLayout(self.frame_165)
        self.horizontalLayout_242.setObjectName(u"horizontalLayout_242")
        self.label_105 = QLabel(self.frame_165)
        self.label_105.setObjectName(u"label_105")
        self.label_105.setFont(font6)

        self.horizontalLayout_242.addWidget(self.label_105)

        self.P02_4 = QComboBox(self.frame_165)
        self.P02_4.addItem("")
        self.P02_4.addItem("")
        self.P02_4.addItem("")
        self.P02_4.addItem("")
        self.P02_4.addItem("")
        self.P02_4.setObjectName(u"P02_4")
        self.P02_4.setEnabled(False)
        self.P02_4.setMinimumSize(QSize(0, 20))
        self.P02_4.setMaximumSize(QSize(16777215, 20))

        self.horizontalLayout_242.addWidget(self.P02_4)


        self.verticalLayout_411.addWidget(self.frame_165)

        self.frame_166 = QFrame(self.frameParameter01_8)
        ...
        self.horizontalLayout_243 = QHBoxLayout(self.frame_166)
        self.horizontalLayout_243.setObjectName(u"horizontalLayout_243")
        self.horizontalLayout_243.setContentsMargins(0, 0, 0, 0)
        self.frame_623 = QFrame(self.frame_166)
        self.frame_623.setObjectName(u"frame_623")
        self.frame_623.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_623.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_64 = QHBoxLayout(self.frame_623)
        self.horizontalLayout_64.setObjectName(u"horizontalLayout_64")
        self.label_106 = QLabel(self.frame_623)
        self.label_106.setObjectName(u"label_106")

        self.horizontalLayout_64.addWidget(self.label_106)

        self.minP02_4 = QLineEdit(self.frame_623)
        self.minP02_4.setObjectName(u"minP02_4")
        self.minP02_4.setEnabled(False)
        self.minP02_4.setMinimumSize(QSize(0, 20))
        self.minP02_4.setMaximumSize(QSize(16777215, 20))
        self.minP02_4.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_64.addWidget(self.minP02_4)

        self.label_107 = QLabel(self.frame_623)
        self.label_107.setObjectName(u"label_107")

        self.horizontalLayout_64.addWidget(self.label_107)

        self.maxP02_4 = QLineEdit(self.frame_623)
        self.maxP02_4.setObjectName(u"maxP02_4")
        self.maxP02_4.setEnabled(False)
        self.maxP02_4.setMinimumSize(QSize(0, 20))
        self.maxP02_4.setMaximumSize(QSize(16777215, 20))
        self.maxP02_4.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_64.addWidget(self.maxP02_4)

        self.label_108 = QLabel(self.frame_623)
        self.label_108.setObjectName(u"label_108")

        self.horizontalLayout_64.addWidget(self.label_108)

        self.stepP02_4 = QComboBox(self.frame_623)
        self.stepP02_4.addItem("")
        self.stepP02_4.addItem("")
        self.stepP02_4.addItem("")
        self.stepP02_4.addItem("")
        self.stepP02_4.addItem("")
        ...
        self.stepP02_4.addItem("")
        self.stepP02_4.addItem("")
        self.stepP02_4.setObjectName(u"stepP02_4")
        self.stepP02_4.setEnabled(False)
        self.stepP02_4.setMinimumSize(QSize(0, 20))
        self.stepP02_4.setMaximumSize(QSize(16777215, 20))
        self.stepP02_4.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.stepP02_4.setStyleSheet(u"QComboBox {\n"
"	padding-left: 23px;\n"
"}")
        self.stepP02_4.setInsertPolicy(QComboBox.InsertPolicy.InsertAtBottom)
        self.stepP02_4.setSizeAdjustPolicy(QComboBox.SizeAdjustPolicy.AdjustToContentsOnFirstShow)

        self.horizontalLayout_64.addWidget(self.stepP02_4)


        self.horizontalLayout_243.addWidget(self.frame_623)


        self.verticalLayout_411.addWidget(self.frame_166)


        self.verticalLayout_54.addWidget(self.frameParameter01_8)

        self.iterationWarning_4 = QFrame(self.frame_76)
        self.iterationWarning_4.setObjectName(u"iterationWarning_4")
        self.iterationWarning_4.setMinimumSize(QSize(0, 30))
        self.iterationWarning_4.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.iterationWarning_4.setFrameShape(QFrame.Shape.StyledPanel)
        self.iterationWarning_4.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_56 = QVBoxLayout(self.iterationWarning_4)
        self.verticalLayout_56.setSpacing(0)
        self.verticalLayout_56.setObjectName(u"verticalLayout_56")
        self.verticalLayout_56.setContentsMargins(5, 0, 5, 0)
        self.labelIterationWarning_4 = QLabel(self.iterationWarning_4)
        self.labelIterationWarning_4.setObjectName(u"labelIterationWarning_4")
        self.labelIterationWarning_4.setMinimumSize(QSize(0, 20))
        self.labelIterationWarning_4.setStyleSheet(u"color: rgb(255, 0, 0);\n"
"font-size: 12px;")
        self.labelIterationWarning_4.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_56.addWidget(self.labelIterationWarning_4)


        self.verticalLayout_54.addWidget(self.iterationWarning_4)


        self.horizontalLayout.addWidget(self.frame_76)

        self.frame_78 = QFrame(self.frame_480)
        self.frame_78.setObjectName(u"frame_78")
        self.frame_78.setStyleSheet(u"QLabel {\n"
"    font-size: 15px; /* Tamanho da fonte */\n"
"	font-family: \"Yu Gothic UI Semilight\"; /* Fam\u00edlia da fonte */\n"
"}\n"
"\n"
...
"")
        ...
        self.verticalLayout_57 = QVBoxLayout(self.frame_78)
        self.verticalLayout_57.setObjectName(u"verticalLayout_57")
        self.frame_624 = QFrame(self.frame_78)
        self.frame_624.setObjectName(u"frame_624")
        self.frame_624.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.frame_624.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_624.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_65 = QHBoxLayout(self.frame_624)
        self.horizontalLayout_65.setObjectName(u"horizontalLayout_65")
        self.label_109 = QLabel(self.frame_624)
        self.label_109.setObjectName(u"label_109")
        self.label_109.setFont(font6)

        self.horizontalLayout_65.addWidget(self.label_109)

        self.numberOfVariables_5 = QComboBox(self.frame_624)
        self.numberOfVariables_5.addItem("")
        self.numberOfVariables_5.addItem("")
        self.numberOfVariables_5.addItem("")
        self.numberOfVariables_5.setObjectName(u"numberOfVariables_5")
        self.numberOfVariables_5.setMinimumSize(QSize(60, 20))
        self.numberOfVariables_5.setMaximumSize(QSize(60, 20))
        self.numberOfVariables_5.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.numberOfVariables_5.setStyleSheet(u"QComboBox {\n"
"	padding-left: 10px;\n"
"}")
        self.numberOfVariables_5.setFrame(True)

        self.horizontalLayout_65.addWidget(self.numberOfVariables_5)


        self.verticalLayout_57.addWidget(self.frame_624)

        self.frameParameter01_9 = QFrame(self.frame_78)
        self.frameParameter01_9.setObjectName(u"frameParameter01_9")
        self.frameParameter01_9.setEnabled(True)
        self.frameParameter01_9.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.frameParameter01_9.setFrameShape(QFrame.Shape.StyledPanel)
        self.frameParameter01_9.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_106 = QVBoxLayout(self.frameParameter01_9)
        self.verticalLayout_106.setObjectName(u"verticalLayout_106")
        self.verticalLayout_106.setContentsMargins(0, -1, 0, -1)
        self.frame_136 = QFrame(self.frameParameter01_9)
        ...
        self.label_110 = QLabel(self.frame_136)
        self.label_110.setObjectName(u"label_110")
        self.label_110.setFont(font6)

        self.horizontalLayout_66.addWidget(self.label_110)

        self.P01_5 = QComboBox(self.frame_136)
        self.P01_5.addItem("")
        self.P01_5.addItem("")
        self.P01_5.addItem("")
        self.P01_5.addItem("")
        self.P01_5.addItem("")
        self.P01_5.setObjectName(u"P01_5")
        self.P01_5.setEnabled(False)
        self.P01_5.setMinimumSize(QSize(0, 20))
        self.P01_5.setMaximumSize(QSize(16777215, 20))

        self.horizontalLayout_66.addWidget(self.P01_5)


        self.verticalLayout_106.addWidget(self.frame_136)

        self.frame_79 = QFrame(self.frameParameter01_9)
        self.frame_79.setObjectName(u"frame_79")
        self.frame_79.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_79.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_67 = QHBoxLayout(self.frame_79)
        self.horizontalLayout_67.setSpacing(10)
        self.horizontalLayout_67.setObjectName(u"horizontalLayout_67")
        self.label_111 = QLabel(self.frame_79)
        self.label_111.setObjectName(u"label_111")

        self.horizontalLayout_67.addWidget(self.label_111)

        self.minP01_5 = QLineEdit(self.frame_79)
        self.minP01_5.setObjectName(u"minP01_5")
        self.minP01_5.setEnabled(False)
        self.minP01_5.setMinimumSize(QSize(0, 20))
        self.minP01_5.setMaximumSize(QSize(16777215, 20))
        self.minP01_5.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_67.addWidget(self.minP01_5)

        self.label_112 = QLabel(self.frame_79)
        self.label_112.setObjectName(u"label_112")

        self.horizontalLayout_67.addWidget(self.label_112)

        self.maxP01_5 = QLineEdit(self.frame_79)
        self.maxP01_5.setObjectName(u"maxP01_5")
        self.maxP01_5.setEnabled(False)
        self.maxP01_5.setMinimumSize(QSize(0, 20))
        self.maxP01_5.setMaximumSize(QSize(16777215, 20))
        self.maxP01_5.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_67.addWidget(self.maxP01_5)

        self.label_113 = QLabel(self.frame_79)
        self.label_113.setObjectName(u"label_113")

        self.horizontalLayout_67.addWidget(self.label_113)

        self.stepP01_5 = QComboBox(self.frame_79)
        self.stepP01_5.addItem("")
        self.stepP01_5.addItem("")
        self.stepP01_5.addItem("")
        self.stepP01_5.addItem("")
        self.stepP01_5.addItem("")
        ...
        self.stepP01_5.addItem("")
        self.stepP01_5.addItem("")
        self.stepP01_5.setObjectName(u"stepP01_5")
        self.stepP01_5.setEnabled(False)
        self.stepP01_5.setMinimumSize(QSize(0, 20))
        self.stepP01_5.setMaximumSize(QSize(16777215, 20))
        self.stepP01_5.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.stepP01_5.setStyleSheet(u"QComboBox {\n"
"	padding-left: 23px;\n"
"}")
        self.stepP01_5.setInsertPolicy(QComboBox.InsertPolicy.InsertAtBottom)
        self.stepP01_5.setSizeAdjustPolicy(QComboBox.SizeAdjustPolicy.AdjustToContentsOnFirstShow)

        self.horizontalLayout_67.addWidget(self.stepP01_5)


        self.verticalLayout_106.addWidget(self.frame_79)


        self.verticalLayout_57.addWidget(self.frameParameter01_9)

        self.frameParameter01_10 = QFrame(self.frame_78)
        self.frameParameter01_10.setObjectName(u"frameParameter01_10")
        self.frameParameter01_10.setEnabled(True)
        self.frameParameter01_10.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.frameParameter01_10.setFrameShape(QFrame.Shape.StyledPanel)
        self.frameParameter01_10.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_412 = QVBoxLayout(self.frameParameter01_10)
        self.verticalLayout_412.setObjectName(u"verticalLayout_412")
        self.verticalLayout_412.setContentsMargins(0, -1, 0, -1)
        self.frame_167 = QFrame(self.frameParameter01_10)
        ...
        self.horizontalLayout_244 = QHBoxLayout(self.frame_167)
        self.horizontalLayout_244.setObjectName(u"horizontalLayout_244")
        self.label_114 = QLabel(self.frame_167)
        self.label_114.setObjectName(u"label_114")
        self.label_114.setFont(font6)

        self.horizontalLayout_244.addWidget(self.label_114)

        self.P02_5 = QComboBox(self.frame_167)
        self.P02_5.addItem("")
        self.P02_5.addItem("")
        self.P02_5.addItem("")
        self.P02_5.addItem("")
        self.P02_5.addItem("")
        self.P02_5.setObjectName(u"P02_5")
        self.P02_5.setEnabled(False)
        self.P02_5.setMinimumSize(QSize(0, 20))
        self.P02_5.setMaximumSize(QSize(16777215, 20))

        self.horizontalLayout_244.addWidget(self.P02_5)


        self.verticalLayout_412.addWidget(self.frame_167)

        self.frame_168 = QFrame(self.frameParameter01_10)
        ...
        self.horizontalLayout_245 = QHBoxLayout(self.frame_168)
        self.horizontalLayout_245.setObjectName(u"horizontalLayout_245")
        self.horizontalLayout_245.setContentsMargins(0, 0, 0, 0)
        self.frame_625 = QFrame(self.frame_168)
        self.frame_625.setObjectName(u"frame_625")
        self.frame_625.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_625.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_68 = QHBoxLayout(self.frame_625)
        self.horizontalLayout_68.setObjectName(u"horizontalLayout_68")
        self.label_115 = QLabel(self.frame_625)
        self.label_115.setObjectName(u"label_115")

        self.horizontalLayout_68.addWidget(self.label_115)

        self.minP02_5 = QLineEdit(self.frame_625)
        self.minP02_5.setObjectName(u"minP02_5")
        self.minP02_5.setEnabled(False)
        self.minP02_5.setMinimumSize(QSize(0, 20))
        self.minP02_5.setMaximumSize(QSize(16777215, 20))
        self.minP02_5.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_68.addWidget(self.minP02_5)

        self.label_116 = QLabel(self.frame_625)
        self.label_116.setObjectName(u"label_116")

        self.horizontalLayout_68.addWidget(self.label_116)

        self.maxP02_5 = QLineEdit(self.frame_625)
        self.maxP02_5.setObjectName(u"maxP02_5")
        self.maxP02_5.setEnabled(False)
        self.maxP02_5.setMinimumSize(QSize(0, 20))
        self.maxP02_5.setMaximumSize(QSize(16777215, 20))
        self.maxP02_5.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_68.addWidget(self.maxP02_5)

        self.label_125 = QLabel(self.frame_625)
        self.label_125.setObjectName(u"label_125")

        self.horizontalLayout_68.addWidget(self.label_125)

        self.stepP02_5 = QComboBox(self.frame_625)
        self.stepP02_5.addItem("")
        self.stepP02_5.addItem("")
        self.stepP02_5.addItem("")
        self.stepP02_5.addItem("")
        self.stepP02_5.addItem("")
        ...
        self.stepP02_5.addItem("")
        self.stepP02_5.addItem("")
        self.stepP02_5.setObjectName(u"stepP02_5")
        self.stepP02_5.setEnabled(False)
        self.stepP02_5.setMinimumSize(QSize(0, 20))
        self.stepP02_5.setMaximumSize(QSize(16777215, 20))
        self.stepP02_5.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.stepP02_5.setStyleSheet(u"QComboBox {\n"
"	padding-left: 23px;\n"
"}")
        self.stepP02_5.setInsertPolicy(QComboBox.InsertPolicy.InsertAtBottom)
        self.stepP02_5.setSizeAdjustPolicy(QComboBox.SizeAdjustPolicy.AdjustToContentsOnFirstShow)

        self.horizontalLayout_68.addWidget(self.stepP02_5)


        self.horizontalLayout_245.addWidget(self.frame_625)


        self.verticalLayout_412.addWidget(self.frame_168)


        self.verticalLayout_57.addWidget(self.frameParameter01_10)

        self.iterationWarning_5 = QFrame(self.frame_78)
        self.iterationWarning_5.setObjectName(u"iterationWarning_5")
        self.iterationWarning_5.setMinimumSize(QSize(0, 30))
        self.iterationWarning_5.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.iterationWarning_5.setFrameShape(QFrame.Shape.StyledPanel)
        self.iterationWarning_5.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_58 = QVBoxLayout(self.iterationWarning_5)
        self.verticalLayout_58.setSpacing(0)
        self.verticalLayout_58.setObjectName(u"verticalLayout_58")
        self.verticalLayout_58.setContentsMargins(5, 0, 5, 0)
        self.labelIterationWarning_5 = QLabel(self.iterationWarning_5)
        self.labelIterationWarning_5.setObjectName(u"labelIterationWarning_5")
        self.labelIterationWarning_5.setMinimumSize(QSize(0, 20))
        self.labelIterationWarning_5.setStyleSheet(u"color: rgb(255, 0, 0);\n"
"font-size: 12px;")
        self.labelIterationWarning_5.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_58.addWidget(self.labelIterationWarning_5)


        self.verticalLayout_57.addWidget(self.iterationWarning_5)


        self.horizontalLayout.addWidget(self.frame_78)

        self.frame_68 = QFrame(self.frame_480)
...
"")
        ...
        self.verticalLayout_50 = QVBoxLayout(self.frame_68)
        self.verticalLayout_50.setObjectName(u"verticalLayout_50")
        self.frame_618 = QFrame(self.frame_68)
        self.frame_618.setObjectName(u"frame_618")
        self.frame_618.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.frame_618.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_618.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_48 = QHBoxLayout(self.frame_618)
        self.horizontalLayout_48.setObjectName(u"horizontalLayout_48")
        self.label_40 = QLabel(self.frame_618)
        self.label_40.setObjectName(u"label_40")
        self.label_40.setFont(font6)

        self.horizontalLayout_48.addWidget(self.label_40)

        self.numberOfVariables_2 = QComboBox(self.frame_618)
        self.numberOfVariables_2.addItem("")
        self.numberOfVariables_2.addItem("")
        self.numberOfVariables_2.addItem("")
        self.numberOfVariables_2.setObjectName(u"numberOfVariables_2")
        self.numberOfVariables_2.setMinimumSize(QSize(60, 20))
        self.numberOfVariables_2.setMaximumSize(QSize(60, 20))
        self.numberOfVariables_2.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.numberOfVariables_2.setStyleSheet(u"QComboBox {\n"
"	padding-left: 10px;\n"
"}")
        self.numberOfVariables_2.setFrame(True)

        self.horizontalLayout_48.addWidget(self.numberOfVariables_2)


        self.verticalLayout_50.addWidget(self.frame_618)

        self.frameParameter01_3 = QFrame(self.frame_68)
        self.frameParameter01_3.setObjectName(u"frameParameter01_3")
        self.frameParameter01_3.setEnabled(True)
        self.frameParameter01_3.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.frameParameter01_3.setFrameShape(QFrame.Shape.StyledPanel)
        self.frameParameter01_3.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_103 = QVBoxLayout(self.frameParameter01_3)
        self.verticalLayout_103.setObjectName(u"verticalLayout_103")
        self.verticalLayout_103.setContentsMargins(0, -1, 0, -1)
        self.frame_133 = QFrame(self.frameParameter01_3)
        ...
        self.label_47 = QLabel(self.frame_133)
        self.label_47.setObjectName(u"label_47")
        self.label_47.setFont(font6)

        self.horizontalLayout_58.addWidget(self.label_47)

        self.P01_2 = QComboBox(self.frame_133)
        self.P01_2.addItem("")
        self.P01_2.addItem("")
        self.P01_2.addItem("")
        self.P01_2.addItem("")
        self.P01_2.addItem("")
        self.P01_2.setObjectName(u"P01_2")
        self.P01_2.setEnabled(False)
        self.P01_2.setMinimumSize(QSize(0, 20))
        self.P01_2.setMaximumSize(QSize(16777215, 20))

        self.horizontalLayout_58.addWidget(self.P01_2)


        self.verticalLayout_103.addWidget(self.frame_133)

        self.frame_69 = QFrame(self.frameParameter01_3)
        self.frame_69.setObjectName(u"frame_69")
        self.frame_69.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_69.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_49 = QHBoxLayout(self.frame_69)
        self.horizontalLayout_49.setSpacing(10)
        self.horizontalLayout_49.setObjectName(u"horizontalLayout_49")
        self.label_48 = QLabel(self.frame_69)
        self.label_48.setObjectName(u"label_48")

        self.horizontalLayout_49.addWidget(self.label_48)

        self.minP01_2 = QLineEdit(self.frame_69)
        self.minP01_2.setObjectName(u"minP01_2")
        self.minP01_2.setEnabled(False)
        self.minP01_2.setMinimumSize(QSize(0, 20))
        self.minP01_2.setMaximumSize(QSize(16777215, 20))
        self.minP01_2.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_49.addWidget(self.minP01_2)

        self.label_49 = QLabel(self.frame_69)
        self.label_49.setObjectName(u"label_49")

        self.horizontalLayout_49.addWidget(self.label_49)

        self.maxP01_2 = QLineEdit(self.frame_69)
        self.maxP01_2.setObjectName(u"maxP01_2")
        self.maxP01_2.setEnabled(False)
        self.maxP01_2.setMinimumSize(QSize(0, 20))
        self.maxP01_2.setMaximumSize(QSize(16777215, 20))
        self.maxP01_2.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_49.addWidget(self.maxP01_2)

        self.label_50 = QLabel(self.frame_69)
        self.label_50.setObjectName(u"label_50")

        self.horizontalLayout_49.addWidget(self.label_50)

        self.stepP01_2 = QComboBox(self.frame_69)
        self.stepP01_2.addItem("")
        self.stepP01_2.addItem("")
        self.stepP01_2.addItem("")
        self.stepP01_2.addItem("")
        self.stepP01_2.addItem("")
        ...
        self.stepP01_2.addItem("")
        self.stepP01_2.addItem("")
        self.stepP01_2.setObjectName(u"stepP01_2")
        self.stepP01_2.setEnabled(False)
        self.stepP01_2.setMinimumSize(QSize(0, 20))
        self.stepP01_2.setMaximumSize(QSize(16777215, 20))
        self.stepP01_2.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.stepP01_2.setStyleSheet(u"QComboBox {\n"
"	padding-left: 23px;\n"
"}")
        self.stepP01_2.setInsertPolicy(QComboBox.InsertPolicy.InsertAtBottom)
        self.stepP01_2.setSizeAdjustPolicy(QComboBox.SizeAdjustPolicy.AdjustToContentsOnFirstShow)

        self.horizontalLayout_49.addWidget(self.stepP01_2)


        self.verticalLayout_103.addWidget(self.frame_69)


        self.verticalLayout_50.addWidget(self.frameParameter01_3)

        self.frameParameter01_4 = QFrame(self.frame_68)
        self.frameParameter01_4.setObjectName(u"frameParameter01_4")
        self.frameParameter01_4.setEnabled(True)
        self.frameParameter01_4.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.frameParameter01_4.setFrameShape(QFrame.Shape.StyledPanel)
        self.frameParameter01_4.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_409 = QVBoxLayout(self.frameParameter01_4)
        self.verticalLayout_409.setObjectName(u"verticalLayout_409")
        self.verticalLayout_409.setContentsMargins(0, -1, 0, -1)
        self.frame_159 = QFrame(self.frameParameter01_4)
        self.frame_159.setObjectName(u"frame_159")
        self.frame_159.setEnabled(True)
        self.frame_159.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_159.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_238 = QHBoxLayout(self.frame_159)
        self.horizontalLayout_238.setObjectName(u"horizontalLayout_238")
        self.label_32 = QLabel(self.frame_159)
        self.label_32.setObjectName(u"label_32")
        self.label_32.setFont(font6)

        self.horizontalLayout_238.addWidget(self.label_32)

        self.P02_2 = QComboBox(self.frame_159)
        self.P02_2.addItem("")
        self.P02_2.addItem("")
        self.P02_2.addItem("")
        self.P02_2.addItem("")
        self.P02_2.addItem("")
        self.P02_2.setObjectName(u"P02_2")
        self.P02_2.setEnabled(False)
        self.P02_2.setMinimumSize(QSize(0, 20))
        self.P02_2.setMaximumSize(QSize(16777215, 20))

        self.horizontalLayout_238.addWidget(self.P02_2)


        self.verticalLayout_409.addWidget(self.frame_159)

        self.frame_162 = QFrame(self.frameParameter01_4)
        ...
        self.horizontalLayout_239 = QHBoxLayout(self.frame_162)
        self.horizontalLayout_239.setObjectName(u"horizontalLayout_239")
        self.horizontalLayout_239.setContentsMargins(0, 0, 0, 0)
        self.frame_619 = QFrame(self.frame_162)
        self.frame_619.setObjectName(u"frame_619")
        self.frame_619.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_619.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_50 = QHBoxLayout(self.frame_619)
        self.horizontalLayout_50.setObjectName(u"horizontalLayout_50")
        self.label_33 = QLabel(self.frame_619)
        self.label_33.setObjectName(u"label_33")

        self.horizontalLayout_50.addWidget(self.label_33)

        self.minP02_2 = QLineEdit(self.frame_619)
        self.minP02_2.setObjectName(u"minP02_2")
        self.minP02_2.setEnabled(False)
        self.minP02_2.setMinimumSize(QSize(0, 20))
        self.minP02_2.setMaximumSize(QSize(16777215, 20))
        self.minP02_2.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_50.addWidget(self.minP02_2)

        self.label_34 = QLabel(self.frame_619)
        self.label_34.setObjectName(u"label_34")

        self.horizontalLayout_50.addWidget(self.label_34)

        self.maxP02_2 = QLineEdit(self.frame_619)
        self.maxP02_2.setObjectName(u"maxP02_2")
        self.maxP02_2.setEnabled(False)
        self.maxP02_2.setMinimumSize(QSize(0, 20))
        self.maxP02_2.setMaximumSize(QSize(16777215, 20))
        self.maxP02_2.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_50.addWidget(self.maxP02_2)

        self.label_38 = QLabel(self.frame_619)
        self.label_38.setObjectName(u"label_38")

        self.horizontalLayout_50.addWidget(self.label_38)

        self.stepP02_2 = QComboBox(self.frame_619)
        self.stepP02_2.addItem("")
        self.stepP02_2.addItem("")
        self.stepP02_2.addItem("")
        self.stepP02_2.addItem("")
        self.stepP02_2.addItem("")
        ...
        self.stepP02_2.addItem("")
        self.stepP02_2.addItem("")
        self.stepP02_2.setObjectName(u"stepP02_2")
        self.stepP02_2.setEnabled(False)
        self.stepP02_2.setMinimumSize(QSize(0, 20))
        self.stepP02_2.setMaximumSize(QSize(16777215, 20))
        self.stepP02_2.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.stepP02_2.setStyleSheet(u"QComboBox {\n"
"	padding-left: 23px;\n"
"}")
        self.stepP02_2.setInsertPolicy(QComboBox.InsertPolicy.InsertAtBottom)
        self.stepP02_2.setSizeAdjustPolicy(QComboBox.SizeAdjustPolicy.AdjustToContentsOnFirstShow)

        self.horizontalLayout_50.addWidget(self.stepP02_2)


        self.horizontalLayout_239.addWidget(self.frame_619)


        self.verticalLayout_409.addWidget(self.frame_162)


        self.verticalLayout_50.addWidget(self.frameParameter01_4)

        self.iterationWarning_2 = QFrame(self.frame_68)
        self.iterationWarning_2.setObjectName(u"iterationWarning_2")
        self.iterationWarning_2.setMinimumSize(QSize(0, 30))
        self.iterationWarning_2.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"")
        self.iterationWarning_2.setFrameShape(QFrame.Shape.StyledPanel)
        self.iterationWarning_2.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_51 = QVBoxLayout(self.iterationWarning_2)
        self.verticalLayout_51.setSpacing(0)
        self.verticalLayout_51.setObjectName(u"verticalLayout_51")
        self.verticalLayout_51.setContentsMargins(5, 0, 5, 0)
        self.labelIterationWarning_2 = QLabel(self.iterationWarning_2)
        self.labelIterationWarning_2.setObjectName(u"labelIterationWarning_2")
        self.labelIterationWarning_2.setMinimumSize(QSize(0, 20))
        self.labelIterationWarning_2.setStyleSheet(u"color: rgb(255, 0, 0);\n"
"font-size: 12px;")
        self.labelIterationWarning_2.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_51.addWidget(self.labelIterationWarning_2)


        self.verticalLayout_50.addWidget(self.iterationWarning_2)


        self.horizontalLayout.addWidget(self.frame_68)


        self.verticalLayout_9.addWidget(self.frame_480)

        self.frame_614 = QFrame(self.frame_8)
        self.frame_614.setObjectName(u"frame_614")
        self.frame_614.setMinimumSize(QSize(0, 60))
        self.frame_614.setMaximumSize(QSize(16777215, 60))
        self.frame_614.setStyleSheet(u"QFrame {\n"
"    background-color: rgb(182, 182, 182);\n"
"    border-radius: 15px; \n"
"}\n"
"\n"
...
"	background-color:rgb(70, 70, 70);\n"
"}")
        self.frame_614.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_614.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_236 = QHBoxLayout(self.frame_614)
        self.horizontalLayout_236.setSpacing(0)
        self.horizontalLayout_236.setObjectName(u"horizontalLayout_236")
        self.horizontalLayout_236.setContentsMargins(18, 0, 18, 0)
        self.frame_615 = QFrame(self.frame_614)
        self.frame_615.setObjectName(u"frame_615")
        self.frame_615.setMinimumSize(QSize(351, 0))
        self.frame_615.setMaximumSize(QSize(351, 81))
        self.frame_615.setStyleSheet(u"")
        self.frame_615.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_615.setFrameShadow(QFrame.Shadow.Raised)
        self.horizontalLayout_237 = QHBoxLayout(self.frame_615)
        self.horizontalLayout_237.setObjectName(u"horizontalLayout_237")
        self.returnButton_3 = QPushButton(self.frame_615)
        self.returnButton_3.setObjectName(u"returnButton_3")
        self.returnButton_3.setEnabled(True)
        self.returnButton_3.setMinimumSize(QSize(100, 36))
        self.returnButton_3.setMaximumSize(QSize(100, 16777215))
        self.returnButton_3.setFont(font5)
        self.returnButton_3.setStyleSheet(u"")

        self.horizontalLayout_237.addWidget(self.returnButton_3)

        self.applyButton_3 = QPushButton(self.frame_615)
        self.applyButton_3.setObjectName(u"applyButton_3")
        self.applyButton_3.setEnabled(True)
        self.applyButton_3.setMinimumSize(QSize(100, 36))
        self.applyButton_3.setMaximumSize(QSize(150, 16777215))
        self.applyButton_3.setFont(font5)

        self.horizontalLayout_237.addWidget(self.applyButton_3)

        self.saveButton_3 = QPushButton(self.frame_615)
        self.saveButton_3.setObjectName(u"saveButton_3")
        self.saveButton_3.setEnabled(False)
        self.saveButton_3.setMinimumSize(QSize(100, 36))
        self.saveButton_3.setMaximumSize(QSize(150, 16777215))
        self.saveButton_3.setFont(font5)
        self.saveButton_3.setStyleSheet(u"")

        self.horizontalLayout_237.addWidget(self.saveButton_3)


        self.horizontalLayout_236.addWidget(self.frame_615)


        self.verticalLayout_9.addWidget(self.frame_614)


        self.horizontalLayout_188.addWidget(self.frame_8)


        self.verticalLayout_315.addWidget(self.frame_479)


        self.verticalLayout_6.addWidget(self.frame_158)

        self.pages.addWidget(self.iterateAndDirectoryPage)
...
"}")
        ...
        self.frame_6 = QFrame(self.infoFrame)
...
"")
        ...
        self.frameParameter01_12 = QFrame(self.frame_6)
...
"}")
        ...
        self.core = QLabel(self.frame_139)
        self.core.setObjectName(u"core")
        self.core.setMinimumSize(QSize(0, 20))
        self.core.setMaximumSize(QSize(100, 20))
        self.core.setStyleSheet(u"QLabel{\n"
"	color: rgb(0, 0, 0);\n"
"	background-color: rgba(255, 255, 255, 150);\n"
"	border-radius: 10px;\n"
"    font-size: 12px; /* Tamanho da fonte */\n"
...
"\n"
"")
        self.core.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.frame_205 = QFrame(self.infoFrame)
...
"}")
        ...
        self.returnIterationButon = QPushButton(self.frame_206)
        self.returnIterationButon.setObjectName(u"returnIterationButon")
        self.returnIterationButon.setEnabled(True)
        self.returnIterationButon.setMinimumSize(QSize(50, 36))
        self.returnIterationButon.setMaximumSize(QSize(115, 16777215))
        self.returnIterationButon.setFont(font5)
        self.returnIterationButon.setStyleSheet(u"")

        self.horizontalLayout_82.addWidget(self.returnIterationButon)
        ...
        self.verticalLayout_13.addWidget(self.frame_205)
...
"}")
        ...
        self.plot_2 = QFrame(self.frame_481)
        self.plot_2.setObjectName(u"plot_2")
        self.plot_2.setMinimumSize(QSize(600, 600))
        self.plot_2.setStyleSheet(u"QFrame {\n"
"     border-radius: 0 px; \n"
"	 border: 0px solid #3498db;\n"
"}")
        self.plot_2.setFrameShape(QFrame.Shape.StyledPanel)
        self.plot_2.setFrameShadow(QFrame.Shadow.Raised)

        self.verticalLayout_316.addWidget(self.plot_2)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_3.setText(QCoreApplication.translate("MainWindow", u"Continue", None))
        ...
        self.label_94.setText(QCoreApplication.translate("MainWindow", u"PARAMETER ITERATION", None))
        self.label_41.setText(QCoreApplication.translate("MainWindow", u"Select the number of Iteration?", None))
        self.numberOfVariables_3.setItemText(0, QCoreApplication.translate("MainWindow", u"None", None))
        self.numberOfVariables_3.setItemText(1, QCoreApplication.translate("MainWindow", u"1", None))
        self.numberOfVariables_3.setItemText(2, QCoreApplication.translate("MainWindow", u"2", None))

        self.numberOfVariables_3.setPlaceholderText(QCoreApplication.translate("MainWindow", u"None", None))
        self.label_95.setText(QCoreApplication.translate("MainWindow", u"Select the parameter:", None))
        self.P01_3.setItemText(0, "")
        self.P01_3.setItemText(1, QCoreApplication.translate("MainWindow", u"Feed", None))
        self.P01_3.setItemText(2, QCoreApplication.translate("MainWindow", u"Rake Angle", None))
        self.P01_3.setItemText(3, QCoreApplication.translate("MainWindow", u"Clearance Angle", None))
        self.P01_3.setItemText(4, QCoreApplication.translate("MainWindow", u"Time Period", None))
        ...
        self.label_98.setText(QCoreApplication.translate("MainWindow", u"Steps:", None))
        self.stepP01_3.setItemText(0, "")
        self.stepP01_3.setItemText(1, QCoreApplication.translate("MainWindow", u"2", None))
        self.stepP01_3.setItemText(2, QCoreApplication.translate("MainWindow", u"3", None))
        self.stepP01_3.setItemText(3, QCoreApplication.translate("MainWindow", u"4", None))
        self.stepP01_3.setItemText(4, QCoreApplication.translate("MainWindow", u"5", None))
        self.stepP01_3.setItemText(5, QCoreApplication.translate("MainWindow", u"6", None))
        self.stepP01_3.setItemText(6, QCoreApplication.translate("MainWindow", u"7", None))
        self.stepP01_3.setItemText(7, QCoreApplication.translate("MainWindow", u"8", None))
        self.stepP01_3.setItemText(8, QCoreApplication.translate("MainWindow", u"9", None))
        self.stepP01_3.setItemText(9, QCoreApplication.translate("MainWindow", u"10", None))

        self.stepP01_3.setCurrentText("")
        self.label_35.setText(QCoreApplication.translate("MainWindow", u"Select the parameter:", None))
        self.P02_3.setItemText(0, "")
        self.P02_3.setItemText(1, QCoreApplication.translate("MainWindow", u"Feed", None))
        self.P02_3.setItemText(2, QCoreApplication.translate("MainWindow", u"Clearance Angle", None))
        self.P02_3.setItemText(3, QCoreApplication.translate("MainWindow", u"Rake Angle", None))
        self.P02_3.setItemText(4, QCoreApplication.translate("MainWindow", u"Time Period", None))

        self.label_36.setText(QCoreApplication.translate("MainWindow", u"Min:", None))
        self.label_42.setText(QCoreApplication.translate("MainWindow", u"Max:", None))
        self.label_99.setText(QCoreApplication.translate("MainWindow", u"Steps:", None))
        self.stepP02_3.setItemText(0, "")
        self.stepP02_3.setItemText(1, QCoreApplication.translate("MainWindow", u"2", None))
        self.stepP02_3.setItemText(2, QCoreApplication.translate("MainWindow", u"3", None))
        self.stepP02_3.setItemText(3, QCoreApplication.translate("MainWindow", u"4", None))
        self.stepP02_3.setItemText(4, QCoreApplication.translate("MainWindow", u"5", None))
        self.stepP02_3.setItemText(5, QCoreApplication.translate("MainWindow", u"6", None))
        self.stepP02_3.setItemText(6, QCoreApplication.translate("MainWindow", u"7", None))
        self.stepP02_3.setItemText(7, QCoreApplication.translate("MainWindow", u"8", None))
        self.stepP02_3.setItemText(8, QCoreApplication.translate("MainWindow", u"9", None))
        self.stepP02_3.setItemText(9, QCoreApplication.translate("MainWindow", u"10", None))

        self.stepP02_3.setCurrentText("")
        self.labelIterationWarning_3.setText(QCoreApplication.translate("MainWindow", u"The parameters min, max and step must be a number", None))
        self.label_100.setText(QCoreApplication.translate("MainWindow", u"Select the number of Iteration?", None))
        self.numberOfVariables_4.setItemText(0, QCoreApplication.translate("MainWindow", u"None", None))
        self.numberOfVariables_4.setItemText(1, QCoreApplication.translate("MainWindow", u"1", None))
        self.numberOfVariables_4.setItemText(2, QCoreApplication.translate("MainWindow", u"2", None))

        self.numberOfVariables_4.setPlaceholderText(QCoreApplication.translate("MainWindow", u"None", None))
        self.label_101.setText(QCoreApplication.translate("MainWindow", u"Select the parameter:", None))
        self.P01_4.setItemText(0, "")
        self.P01_4.setItemText(1, QCoreApplication.translate("MainWindow", u"Feed", None))
        self.P01_4.setItemText(2, QCoreApplication.translate("MainWindow", u"Rake Angle", None))
        self.P01_4.setItemText(3, QCoreApplication.translate("MainWindow", u"Clearance Angle", None))
        self.P01_4.setItemText(4, QCoreApplication.translate("MainWindow", u"Time Period", None))

        self.label_102.setText(QCoreApplication.translate("MainWindow", u"Min:", None))
        self.label_103.setText(QCoreApplication.translate("MainWindow", u"Max:", None))
        self.label_104.setText(QCoreApplication.translate("MainWindow", u"Steps:", None))
        self.stepP01_4.setItemText(0, "")
        self.stepP01_4.setItemText(1, QCoreApplication.translate("MainWindow", u"2", None))
        self.stepP01_4.setItemText(2, QCoreApplication.translate("MainWindow", u"3", None))
        self.stepP01_4.setItemText(3, QCoreApplication.translate("MainWindow", u"4", None))
        self.stepP01_4.setItemText(4, QCoreApplication.translate("MainWindow", u"5", None))
        self.stepP01_4.setItemText(5, QCoreApplication.translate("MainWindow", u"6", None))
        self.stepP01_4.setItemText(6, QCoreApplication.translate("MainWindow", u"7", None))
        self.stepP01_4.setItemText(7, QCoreApplication.translate("MainWindow", u"8", None))
        self.stepP01_4.setItemText(8, QCoreApplication.translate("MainWindow", u"9", None))
        self.stepP01_4.setItemText(9, QCoreApplication.translate("MainWindow", u"10", None))

        self.stepP01_4.setCurrentText("")
        self.label_105.setText(QCoreApplication.translate("MainWindow", u"Select the parameter:", None))
        self.P02_4.setItemText(0, "")
        self.P02_4.setItemText(1, QCoreApplication.translate("MainWindow", u"Feed", None))
        self.P02_4.setItemText(2, QCoreApplication.translate("MainWindow", u"Clearance Angle", None))
        self.P02_4.setItemText(3, QCoreApplication.translate("MainWindow", u"Rake Angle", None))
        self.P02_4.setItemText(4, QCoreApplication.translate("MainWindow", u"Time Period", None))
        ...
        self.label_108.setText(QCoreApplication.translate("MainWindow", u"Steps:", None))
        self.stepP02_4.setItemText(0, "")
        self.stepP02_4.setItemText(1, QCoreApplication.translate("MainWindow", u"2", None))
        self.stepP02_4.setItemText(2, QCoreApplication.translate("MainWindow", u"3", None))
        self.stepP02_4.setItemText(3, QCoreApplication.translate("MainWindow", u"4", None))
        self.stepP02_4.setItemText(4, QCoreApplication.translate("MainWindow", u"5", None))
        self.stepP02_4.setItemText(5, QCoreApplication.translate("MainWindow", u"6", None))
        self.stepP02_4.setItemText(6, QCoreApplication.translate("MainWindow", u"7", None))
        self.stepP02_4.setItemText(7, QCoreApplication.translate("MainWindow", u"8", None))
        self.stepP02_4.setItemText(8, QCoreApplication.translate("MainWindow", u"9", None))
        self.stepP02_4.setItemText(9, QCoreApplication.translate("MainWindow", u"10", None))

        self.stepP02_4.setCurrentText("")
        self.labelIterationWarning_4.setText(QCoreApplication.translate("MainWindow", u"The parameters min, max and step must be a number", None))
        self.label_109.setText(QCoreApplication.translate("MainWindow", u"Select the number of Iteration?", None))
        self.numberOfVariables_5.setItemText(0, QCoreApplication.translate("MainWindow", u"None", None))
        self.numberOfVariables_5.setItemText(1, QCoreApplication.translate("MainWindow", u"1", None))
        self.numberOfVariables_5.setItemText(2, QCoreApplication.translate("MainWindow", u"2", None))

        self.numberOfVariables_5.setPlaceholderText(QCoreApplication.translate("MainWindow", u"None", None))
        self.label_110.setText(QCoreApplication.translate("MainWindow", u"Select the parameter:", None))
        self.P01_5.setItemText(0, "")
        self.P01_5.setItemText(1, QCoreApplication.translate("MainWindow", u"Feed", None))
        self.P01_5.setItemText(2, QCoreApplication.translate("MainWindow", u"Rake Angle", None))
        self.P01_5.setItemText(3, QCoreApplication.translate("MainWindow", u"Clearance Angle", None))
        self.P01_5.setItemText(4, QCoreApplication.translate("MainWindow", u"Time Period", None))

        self.label_111.setText(QCoreApplication.translate("MainWindow", u"Min:", None))
        self.label_112.setText(QCoreApplication.translate("MainWindow", u"Max:", None))
        self.label_113.setText(QCoreApplication.translate("MainWindow", u"Steps:", None))
        self.stepP01_5.setItemText(0, "")
        self.stepP01_5.setItemText(1, QCoreApplication.translate("MainWindow", u"2", None))
        self.stepP01_5.setItemText(2, QCoreApplication.translate("MainWindow", u"3", None))
        self.stepP01_5.setItemText(3, QCoreApplication.translate("MainWindow", u"4", None))
        self.stepP01_5.setItemText(4, QCoreApplication.translate("MainWindow", u"5", None))
        self.stepP01_5.setItemText(5, QCoreApplication.translate("MainWindow", u"6", None))
        self.stepP01_5.setItemText(6, QCoreApplication.translate("MainWindow", u"7", None))
        self.stepP01_5.setItemText(7, QCoreApplication.translate("MainWindow", u"8", None))
        self.stepP01_5.setItemText(8, QCoreApplication.translate("MainWindow", u"9", None))
        self.stepP01_5.setItemText(9, QCoreApplication.translate("MainWindow", u"10", None))

        self.stepP01_5.setCurrentText("")
        self.label_114.setText(QCoreApplication.translate("MainWindow", u"Select the parameter:", None))
        self.P02_5.setItemText(0, "")
        self.P02_5.setItemText(1, QCoreApplication.translate("MainWindow", u"Feed", None))
        self.P02_5.setItemText(2, QCoreApplication.translate("MainWindow", u"Clearance Angle", None))
        self.P02_5.setItemText(3, QCoreApplication.translate("MainWindow", u"Rake Angle", None))
        self.P02_5.setItemText(4, QCoreApplication.translate("MainWindow", u"Time Period", None))
        ...
        self.label_125.setText(QCoreApplication.translate("MainWindow", u"Steps:", None))
        self.stepP02_5.setItemText(0, "")
        self.stepP02_5.setItemText(1, QCoreApplication.translate("MainWindow", u"2", None))
        self.stepP02_5.setItemText(2, QCoreApplication.translate("MainWindow", u"3", None))
        self.stepP02_5.setItemText(3, QCoreApplication.translate("MainWindow", u"4", None))
        self.stepP02_5.setItemText(4, QCoreApplication.translate("MainWindow", u"5", None))
        self.stepP02_5.setItemText(5, QCoreApplication.translate("MainWindow", u"6", None))
        self.stepP02_5.setItemText(6, QCoreApplication.translate("MainWindow", u"7", None))
        self.stepP02_5.setItemText(7, QCoreApplication.translate("MainWindow", u"8", None))
        self.stepP02_5.setItemText(8, QCoreApplication.translate("MainWindow", u"9", None))
        self.stepP02_5.setItemText(9, QCoreApplication.translate("MainWindow", u"10", None))

        self.stepP02_5.setCurrentText("")
        self.labelIterationWarning_5.setText(QCoreApplication.translate("MainWindow", u"The parameters min, max and step must be a number", None))
        self.label_40.setText(QCoreApplication.translate("MainWindow", u"Select the number of Iteration?", None))
        self.numberOfVariables_2.setItemText(0, QCoreApplication.translate("MainWindow", u"None", None))
        self.numberOfVariables_2.setItemText(1, QCoreApplication.translate("MainWindow", u"1", None))
        self.numberOfVariables_2.setItemText(2, QCoreApplication.translate("MainWindow", u"2", None))

        self.numberOfVariables_2.setPlaceholderText(QCoreApplication.translate("MainWindow", u"None", None))
        self.label_47.setText(QCoreApplication.translate("MainWindow", u"Select the parameter:", None))
        self.P01_2.setItemText(0, "")
        self.P01_2.setItemText(1, QCoreApplication.translate("MainWindow", u"Feed", None))
        self.P01_2.setItemText(2, QCoreApplication.translate("MainWindow", u"Rake Angle", None))
        self.P01_2.setItemText(3, QCoreApplication.translate("MainWindow", u"Clearance Angle", None))
        self.P01_2.setItemText(4, QCoreApplication.translate("MainWindow", u"Time Period", None))

        self.label_48.setText(QCoreApplication.translate("MainWindow", u"Min:", None))
        self.label_49.setText(QCoreApplication.translate("MainWindow", u"Max:", None))
        self.label_50.setText(QCoreApplication.translate("MainWindow", u"Steps:", None))
        self.stepP01_2.setItemText(0, "")
        self.stepP01_2.setItemText(1, QCoreApplication.translate("MainWindow", u"2", None))
        self.stepP01_2.setItemText(2, QCoreApplication.translate("MainWindow", u"3", None))
        self.stepP01_2.setItemText(3, QCoreApplication.translate("MainWindow", u"4", None))
        self.stepP01_2.setItemText(4, QCoreApplication.translate("MainWindow", u"5", None))
        self.stepP01_2.setItemText(5, QCoreApplication.translate("MainWindow", u"6", None))
        self.stepP01_2.setItemText(6, QCoreApplication.translate("MainWindow", u"7", None))
        self.stepP01_2.setItemText(7, QCoreApplication.translate("MainWindow", u"8", None))
        self.stepP01_2.setItemText(8, QCoreApplication.translate("MainWindow", u"9", None))
        self.stepP01_2.setItemText(9, QCoreApplication.translate("MainWindow", u"10", None))

        self.stepP01_2.setCurrentText("")
        self.label_32.setText(QCoreApplication.translate("MainWindow", u"Select the parameter:", None))
        self.P02_2.setItemText(0, "")
        self.P02_2.setItemText(1, QCoreApplication.translate("MainWindow", u"Feed", None))
        self.P02_2.setItemText(2, QCoreApplication.translate("MainWindow", u"Clearance Angle", None))
        self.P02_2.setItemText(3, QCoreApplication.translate("MainWindow", u"Rake Angle", None))
        self.P02_2.setItemText(4, QCoreApplication.translate("MainWindow", u"Time Period", None))
        ...
        self.stepP02_2.setItemText(0, "")
        self.stepP02_2.setItemText(1, QCoreApplication.translate("MainWindow", u"2", None))
        self.stepP02_2.setItemText(2, QCoreApplication.translate("MainWindow", u"3", None))
        self.stepP02_2.setItemText(3, QCoreApplication.translate("MainWindow", u"4", None))
        self.stepP02_2.setItemText(4, QCoreApplication.translate("MainWindow", u"5", None))
        self.stepP02_2.setItemText(5, QCoreApplication.translate("MainWindow", u"6", None))
        self.stepP02_2.setItemText(6, QCoreApplication.translate("MainWindow", u"7", None))
        self.stepP02_2.setItemText(7, QCoreApplication.translate("MainWindow", u"8", None))
        self.stepP02_2.setItemText(8, QCoreApplication.translate("MainWindow", u"9", None))
        self.stepP02_2.setItemText(9, QCoreApplication.translate("MainWindow", u"10", None))

        self.stepP02_2.setCurrentText("")
        self.labelIterationWarning_2.setText(QCoreApplication.translate("MainWindow", u"The parameters min, max and step must be a number", None))
        self.returnButton_3.setText(QCoreApplication.translate("MainWindow", u"Return", None))
        self.applyButton_3.setText(QCoreApplication.translate("MainWindow", u"Apply", None))
        self.saveButton_3.setText(QCoreApplication.translate("MainWindow", u"Save", None))
        ...
        self.labelIterationWarning.setText(QCoreApplication.translate("MainWindow", u"The parameters min, max and step must be a number", None))
        ...
        self.core.setText("")
        self.returnIterationButon.setText(QCoreApplication.translate("MainWindow", u"Return", None))
