...
"    color: rgb(0, 0, 0);\n"
"    border: 2px solid rgb(0, 0, 0); /* Borda */\n"
...
"    border: 2px solid #888888; /* Borda quando desativado */\n"
"    color: #666666; /* Cor do texto quando desativado */\n"
"}\n"
"\n"
"QPushButton:checked {\n"
"    background-color:"
                        " rgba(108, 166, 240, 100); \n"
"	color: rgb(0, 0, 0);\n"
...
"}")
        ...
        self.eulerianButton.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.iterateButton = QPushButton(self.frame)
        ...
        self.verticalLayout_3.addWidget(self.iterateButton)
...
"")
        ...
        sizePolicy3.setHeightForWidth(self.frame_61.sizePolicy().hasHeightForWidth())
        self.frame_61.setSizePolicy(sizePolicy3)
...
"")
        ...
        self.eulerianDefaut.setChecked(False)
...
"    }")
        ...
        sizePolicy3.setHeightForWidth(self.plotEulerianArea.sizePolicy().hasHeightForWidth())
        self.plotEulerianArea.setSizePolicy(sizePolicy3)
...
"")
        ...
        sizePolicy3.setHeightForWidth(self.frame_100.sizePolicy().hasHeightForWidth())
        self.frame_100.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.frame_101.sizePolicy().hasHeightForWidth())
        self.frame_101.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.frame_105.sizePolicy().hasHeightForWidth())
        self.frame_105.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.frame_106.sizePolicy().hasHeightForWidth())
        self.frame_106.setSizePolicy(sizePolicy3)
...
"")
        ...
        sizePolicy3.setHeightForWidth(self.frame_113.sizePolicy().hasHeightForWidth())
        self.frame_113.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.frame_118.sizePolicy().hasHeightForWidth())
        self.frame_118.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.frame_119.sizePolicy().hasHeightForWidth())
        self.frame_119.setSizePolicy(sizePolicy3)
...
"")
        ...
        sizePolicy3.setHeightForWidth(self.frame_83.sizePolicy().hasHeightForWidth())
        self.frame_83.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.frame_107.sizePolicy().hasHeightForWidth())
        self.frame_107.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.frame_89.sizePolicy().hasHeightForWidth())
        self.frame_89.setSizePolicy(sizePolicy3)
...
"")
        ...
        self.toolDefaut.setChecked(False)
...
"    }")
        ...
        sizePolicy3.setHeightForWidth(self.plotToolArea.sizePolicy().hasHeightForWidth())
        self.plotToolArea.setSizePolicy(sizePolicy3)
...
"")
        ...
        self.xEulerian.setMinimumSize(QSize(160, 18))
        ...
        sizePolicy3.setHeightForWidth(self.frame_173.sizePolicy().hasHeightForWidth())
        self.frame_173.setSizePolicy(sizePolicy3)
        ...
        self.yEulerian.setMinimumSize(QSize(160, 18))
...
"")
        ...
        sizePolicy3.setHeightForWidth(self.frame_181.sizePolicy().hasHeightForWidth())
        self.frame_181.setSizePolicy(sizePolicy3)
        ...
        self.xTool.setMinimumSize(QSize(160, 18))
        ...
        sizePolicy3.setHeightForWidth(self.frame_186.sizePolicy().hasHeightForWidth())
        self.frame_186.setSizePolicy(sizePolicy3)
        ...
        self.yTool.setMinimumSize(QSize(160, 18))
...
"")
        ...
        sizePolicy3.setHeightForWidth(self.frame_139.sizePolicy().hasHeightForWidth())
        self.frame_139.setSizePolicy(sizePolicy3)
        ...
        self.overWorkpiece.setMinimumSize(QSize(160, 18))
        ...
        sizePolicy3.setHeightForWidth(self.frame_144.sizePolicy().hasHeightForWidth())
        self.frame_144.setSizePolicy(sizePolicy3)
        ...
        self.label_156.setMinimumSize(QSize(220, 18))
        ...
        sizePolicy3.setHeightForWidth(self.frame_145.sizePolicy().hasHeightForWidth())
        self.frame_145.setSizePolicy(sizePolicy3)
        ...
        self.fromTool.setMinimumSize(QSize(160, 18))
...
"")
        ...
        sizePolicy3.setHeightForWidth(self.frame_193.sizePolicy().hasHeightForWidth())
        self.frame_193.setSizePolicy(sizePolicy3)
        ...
        self.feed.setMinimumSize(QSize(160, 18))
        ...
        sizePolicy3.setHeightForWidth(self.frame_198.sizePolicy().hasHeightForWidth())
        self.frame_198.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.frame_199.sizePolicy().hasHeightForWidth())
        self.frame_199.setSizePolicy(sizePolicy3)
        ...
        self.timePeriod.setMinimumSize(QSize(160, 18))
        ...
        self.verticalLayout_43.addItem(self.verticalSpacer_15)

        self.assemblyWarning = QLabel(self.frame_65)
        self.assemblyWarning.setObjectName(u"assemblyWarning")
        self.assemblyWarning.setFont(font3)
        ...
        self.verticalLayout_43.addWidget(self.assemblyWarning)
...
"")
        ...
        self.assemblyDefaut = QCheckBox(self.frame_157)
        self.assemblyDefaut.setObjectName(u"assemblyDefaut")
        sizePolicy4.setHeightForWidth(self.assemblyDefaut.sizePolicy().hasHeightForWidth())
        self.assemblyDefaut.setSizePolicy(sizePolicy4)
        self.assemblyDefaut.setMaximumSize(QSize(16777215, 20))
        self.assemblyDefaut.setLayoutDirection(Qt.LayoutDirection.LeftToRight)

        self.verticalLayout_102.addWidget(self.assemblyDefaut)
...
"    }")
        ...
        sizePolicy3.setHeightForWidth(self.plotAssemblyArea.sizePolicy().hasHeightForWidth())
        self.plotAssemblyArea.setSizePolicy(sizePolicy3)
...
"}")
        ...
        self.chipPlateDefaut.setChecked(False)
...
"    }")
        ...
        sizePolicy3.setHeightForWidth(self.plotChipPlateArea.sizePolicy().hasHeightForWidth())
        self.plotChipPlateArea.setSizePolicy(sizePolicy3)
...
"border-radius: 10px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.assemblyDefaut.setText(QCoreApplication.translate("MainWindow", u"Use defaut values", None))
