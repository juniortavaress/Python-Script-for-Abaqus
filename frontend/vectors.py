...
class Vectors():
    ...
    def chipPlateDatas(self, x, y, z):
        ...
        chip_faces = Vectors.getFaces(self, chip_vertices, vertices_combinations)
        return chip_faces
    ...
    def eulerianDatas(self):
        ...
        eulerian_faces = Vectors.getFaces(self, eulerian_vertices, vertices_combinations)
    ...
    def toolDatas(self, page):
        ...
        tool_faces = Vectors.getFaces(self, tool_vertices, vertices_combinations)
        return tool_faces
