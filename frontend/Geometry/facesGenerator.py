"""          This class is responsible to generate 3D faces and partition for the geometries             """

    # def call_faces                 -> main method to select and generate faces based on the given geometry type
    # def eulerian_and_chip_plate_datas -> generate Chip Plate and Eulerian faces based on user input dimensions
    # def tool_datas                 -> generate Tool faces based on user input dimensions
    # def get_faces                  -> define faces for the geometry using the vertices
    # def create_eulerian_partition   -> create partition for the eulerian geometry
